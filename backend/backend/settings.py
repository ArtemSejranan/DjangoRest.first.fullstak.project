...
SECRET_KEY = 'django-insecure-af6bnf_wev79q8&y_x&lz$)1t#ko$#=2!ic^#m+y9^n+st_rrc'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '10/minute',  # 3 requests per minute
        'user': '20/minute',  # 5 requests per minute   # 10 requests per hour
    },
